# 用 SDD + TDD 驯服 AI：让代码既能「写得快」也能「信得过」

> 来源文件：`raw/01-SDD+TDD驯服AI可靠编程课程/用 SDD + TDD 驯服 AI：让代码既能「写得快」也能「信得过」.ipynb`。本文件仅提取 Notebook 中的 Markdown/Raw 文本单元，已跳过代码单元、运行输出与其他资源。
...
![SDD 定义“什么是对”，TDD 把“对”变成机器能判，一起把概率产出夹回可接受区间](../../01-SDD+TDD驯服AI可靠编程课程/assets/01_sdd_tdd.drawio.svg)
...
> 完整版：[code/backend/spec/todo_api_spec.md](../../01-SDD+TDD驯服AI可靠编程课程/code/backend/spec/todo_api_spec.md)。
...
![spec 沿技术栈向下游传导：spec 探讨→TDD红绿→后端→OpenAPI 契约→前端 UI](../../01-SDD+TDD驯服AI可靠编程课程/assets/02_spec_propagation.drawio.svg)
...
![手工流程固化成流水线：规划/实现/审查 Agent 分工 + CI 门禁，AI 无豁免权](../../01-SDD+TDD驯服AI可靠编程课程/assets/03_pipeline.drawio.svg)
...
![两道审查关：AI 自审抓明显错，人决策抓和意图不符与不可逆操作，都在合并前](../../01-SDD+TDD驯服AI可靠编程课程/assets/04_review.drawio.svg)
...
| 文件 | 用途 |
|---|---|
| [01_spec模板](../../01-SDD+TDD驯服AI可靠编程课程/materials/01_spec模板.md) | 让 AI 写代码前，先填规格 |
| [02_测试先行清单](../../01-SDD+TDD驯服AI可靠编程课程/materials/02_测试先行清单.md) | TDD 红绿循环的操作顺序 |
| [03_API契约约束前端_方法卡](../../01-SDD+TDD驯服AI可靠编程课程/materials/03_API契约约束前端_方法卡.md) | 用 OpenAPI 约束前端的方法 |
| [04_coding-agent选型对照表](../../01-SDD+TDD驯服AI可靠编程课程/materials/04_coding-agent选型对照表.md) | 按方法选工具 |
| [05_Rules模板_AGENTS](../../01-SDD+TDD驯服AI可靠编程课程/materials/05_Rules模板_AGENTS.md) | 项目 Rules 起步模板 |
| [06_审查视角prompt与合并前checklist](../../01-SDD+TDD驯服AI可靠编程课程/materials/06_审查视角prompt与合并前checklist.md) | AI 自审 + 人审两关 |
